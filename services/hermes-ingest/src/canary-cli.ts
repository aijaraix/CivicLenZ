import { armBoundedReturn, armCanary, readAuthorization } from './canary.ts';
...
else throw new Error('usage: canary-cli.ts arm correlation_uuid ttl | arm-production canonical_job_uuid work:v1:<sha256> ttl | inspect correlation_uuid');
