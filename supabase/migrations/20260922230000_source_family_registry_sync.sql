...
WITH seed(source_key, name, source_url, source_type, authority_tier,
  ...
  VALUES
    ...
    ('florida-agriculture-commissioner',
     ...
     jsonb_build_object('minIntervalMs',15000,'maxConcurrent',1), 'official-profile-discovery'),
    ('us-house-members',
     'U.S. House — Directory of Representatives',
     'https://www.house.gov/representatives',
     'html_directory', 'TIER_1_PRIMARY_OFFICIAL', 'us', true, 'LOW', '24h', '6h',
     jsonb_build_object('minIntervalMs',15000,'maxConcurrent',1), 'html-directory'),
    ('us-senate-members',
     'U.S. Senate contact XML',
     'https://www.senate.gov/general/contact_information/senators_cfm.xml',
     'xml_feed', 'TIER_1_PRIMARY_OFFICIAL', 'us', true, 'LOW', '24h', '6h',
     jsonb_build_object('minIntervalMs',15000,'maxConcurrent',1), 'xml-feed'),
